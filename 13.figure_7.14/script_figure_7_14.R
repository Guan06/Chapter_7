...
######### for family ##########################################################
dis_file <- "../12.figure_7.13/Figure_7_13a.txt"
...
dis_file <- "../12.figure_7.13/Figure_7_13b.txt"
...
p_b <- plot_grid(p1, p2, p3, p4, nrow = 1, align = "h", axis = "b",
                 labels = c('b', '', '', ''))

p <- plot_grid(p_a, p_b, nrow = 2)
ggsave("Figure_7_14.pdf", p, height = 5.4, width = 10)
