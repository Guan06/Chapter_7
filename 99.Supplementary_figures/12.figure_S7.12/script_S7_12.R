...
p3 <- plot_density("Jaccard_dis_bs_arabidopsis_thaliana_root_vs_CAS.txt",
                  "Jaccard_dis_pm_arabidopsis_thaliana_root_vs_CAS.txt")
p4 <- plot_density("Jaccard_dis_bs_CAS_vs_lotus_japonicus_root.txt",
                   "Jaccard_dis_pm_CAS_vs_lotus_japonicus_root.txt")
...
ggsave("Figure_S7.12.pdf", height = 3)
