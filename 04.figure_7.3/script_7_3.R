...
p1 <- plot_occu_RA("soil", t = "Class")
p2 <- plot_occu_RA("rhizosphere", t = "Class")
p3 <- plot_occu_RA("rhizoplane", t = "Class")
p4 <- plot_occu_RA("root", t = "Class")
...
p <- plot_grid(p_bac, p_fun, ncol = 1)
ggsave("Figure_7_3.pdf", p, height = 8, width = 8)
