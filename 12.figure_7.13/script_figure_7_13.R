...
#### for family ###############################################################
## permutation including "Unassigned" ASVs
#dis_file <- "/biodata/dep_psl/grp_rgo/guan/20200616_figures/19.MANUSCRIPT/22.CAS/07.figure_4_v20210825/dis_spectra_decrease_single_family.txt"
#dis_mean_file <- "/biodata/dep_psl/grp_rgo/guan/20200616_figures/19.MANUSCRIPT/22.CAS/07.figure_4_v20210825/dis_spectra_decrease_mean_single_family.txt"

## permutation excluding "Unassigned" ASVs
dis_file <- "Family_single_pm_dis.txt"
dis_mean_file <- "Family_single_pm_dis_mean.txt"
...
write.table(dis_merge, "Figure_7_13a.txt",
...
######## for network cluster ##################################################
## permutation including "Unassigned" ASVs
#dis_file <- "/biodata/dep_psl/grp_rgo/guan/20200616_figures/19.MANUSCRIPT/22.CAS/06.figure_4_v20210810/v2_dis_spectra_decrease_single_grp.txt"
#dis_mean_file <- "/biodata/dep_psl/grp_rgo/guan/20200616_figures/19.MANUSCRIPT/22.CAS/06.figure_4_v20210810/v2_dis_spectra_decrease_mean_single_grp.txt"

## Permutation excluding "Unassigned" ASVs
dis_file <- "Cluster_single_pm_dis.txt"
dis_mean_file <- "Cluster_single_pm_dis_mean.txt"
...
write.table(dis_merge, "Figure_7_13b.txt",
            quote = F, sep = "\t", row.names = F)
...
p <- plot_grid(p_a, p_b, nrow = 2, align = "v", axis = "l", labels = 'auto',
               rel_heights = c(1.2, 1))
ggsave("Figure_7_13.pdf", p, width = 10, height = 7)
