...
library(mina)
source("../15.figure_7.17/function_get_pm.R")
...
######### for family ##########################################################
grp_file <- "../15.figure_7.17/Family_single_pm_dis_mean.txt"
asv2grp_file <- "../14.figure_7.16/CAS_ASV_1774_tax.txt"
...
######### for network cluster #################################################
grp_file <- "../15.figure_7.17/Cluster_single_pm_dis_mean.txt"
